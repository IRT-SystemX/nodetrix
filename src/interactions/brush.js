...
(function()
{
	 ...
	 */
	window.interaction.Brush = function(widget) { this.widget = widget; };

	/**
	 * This method updates the different layers
	 */
	window.interaction.Brush.prototype.bind = function(keyBinding) {
		var _this = this;
	 ...
	 * This method updates the different layers
	 */
	window.interaction.Brush.prototype.unbind = function() {
		/*
